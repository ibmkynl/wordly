...
class FavoriteWordRow extends StatelessWidget {
  ...
  const FavoriteWordRow({super.key, required this.word, required this.onTap, required this.dateTime});
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.favorite, color: AppColors.secondaryColor, size: 24.r),
            SizedBox(width: 32.w),
            Expanded(
              child: Column(
